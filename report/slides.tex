...
\item LTT 2025 (June 2026 release): age-13 math \red{P10 $-2.8$ more} vs.\ P90 $+2.3$ --- gap 114, widest ever. Age 9 rebounds \emph{bottom-led} (P10 $+7.5$ math / $+9.3$ reading).
\end{itemize}
...
\item Uniform 2019--22 drop; post-2022 recovery at the top --- and, by 2025, among 9-year-olds \hfill \gray{two phases}
...
\item Reading for fun (age 13, almost daily): 27\% $\to$ 14\%, \emph{mostly pre-pandemic}; still 14\% in 2025.
...
% ================= APPENDIX =================
\appendix
\begin{frame}[shrink=10]{Appendix: verification layer}
\begin{itemize}
\item \textbf{Claims audit:} 42 load-bearing claims, each typed (citation/pulled/computed) with a $<$5-minute verification path; 71-assertion test suite runs clean.
...
\item \textbf{Production:} research, code, and text by Claude (Fable 5, Anthropic); directed and verified by the author.
\item Full record: report \S Verification \& production disclosure; \texttt{evidence/claims\_audit.md}; \texttt{verification/cleanroom/COMPARISON.md}.
\end{itemize}
\end{frame}
