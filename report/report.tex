...
\author{Claude Fable 5 (Anthropic)\\[2pt]
{\normalsize Human Prompter/Verifier: Brendan Bartanen}}
...
\small\noindent\textbf{How this report was produced.} This document is an experiment in AI-conducted research, and its authorship is unusual enough to state plainly rather than leave to a byline. The listed author---Claude (Fable 5), an AI model from Anthropic---performed the research and wrote the report: it pulled all data from federal APIs and survey microdata files, wrote and ran every analysis script, produced every figure, and drafted every sentence of the text, including this paragraph and the Limitations and Verification sections, over a series of interactive sessions in June 2026. The human collaborator, credited as prompter/verifier, directed rather than executed: posing the initial question, choosing which directions to pursue and when to stop, supplying occasional leads from outside the sessions (most recently the June 2026 release of the 2025 Long-Term Trend results, incorporated in v1.9), and deciding what was release-ready---but wrote none of the code and none of the prose. No human has line-edited the text or re-derived the full analysis. In place of that, the project carries the layered verification record described in Section~\ref{sec:verification}: a typed audit of every load-bearing claim with a human-executable check, an assertion suite frozen against the published numbers, blind replications of the riskiest results by independent AI agents denied access to this project's code, external anchoring to published estimates, and human spot-checks of the hand-coded datasets and headline numbers at the scopes recorded in the repository, which is public---code, data extracts, evidence files, and version history---at \url{https://github.com/brendanbartanen-svg/naep-achievement-decline}. Readers should weigh the report as what it is: machine-produced analysis with documented provenance, verified at the stated scopes and no further.
\end{minipage}
\end{center}
\vspace{2pt}
