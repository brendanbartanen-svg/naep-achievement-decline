...
{\large Policy brief accompanying \emph{Why Did American Student Achievement Decline?} \hfill June 12, 2026}\\[1pt]
{\small Brendan Bartanen (University of Virginia) \;\textperiodcentered\; v1.9}
...
{\footnotesize\textit{Score changes by student percentile (national long-term trend assessment, ages 9 and 13). Left: before the pandemic, losses were confined to lower-performing students while top students held steady. Center: the pandemic-era drop hit students at every level --- hardest at the bottom. Right: in results released June 2026, 9-year-olds are rebounding, led by their lowest performers, while 13-year-olds' bottom decile keeps falling in math.}}
\end{center}

\begin{itemize}
\item \textbf{COVID made everything worse, and recovery has stalled --- except, newly, among the youngest.} The pandemic-era drop hit students at every level (center panel above), and four years later the aggregate rebound is minimal: reading is still falling and adolescents' bottom decile keeps sinking even as top students recover. The one genuine bright spot, in national results released June 2026, is 9-year-olds: up about 4 points in both subjects since 2022, with the biggest gains among the lowest performers (right panel above). Thirteen-year-olds show no such turn.
...
\item \textbf{Common Core?} No --- the four states that never adopted it declined right alongside adopters (indistinguishably overall, and more steeply in 8th grade).
...
{\footnotesize All findings are documented, with data and replication code, in the full report: national NAEP, Long-Term Trend, state and urban-district data pulled directly from federal sources; PISA, TIMSS, and PIAAC international data; and 600,000-student PISA microdata. Key sources include NCES/NAEP, OECD, the Education Recovery Scorecard, and peer-reviewed studies cited therein. Research, analysis, and text were produced by Claude (Fable 5, Anthropic) under the author's direction and verification --- see ``How this report was produced'' in the full report. Report, data, and code: \url{github.com/brendanbartanen-svg/naep-achievement-decline}.}
