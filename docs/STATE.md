...
- 4G×SEDA design = best remaining causal idea for H2 pre-pandemic; scoped GO 2026-06-10 (`docs/seda4g_design.md`). Key facts: Form 477 free data starts Dec 2014 = too late (LTE 98.5% by Jan 2014); the rescue is the free NTIA SBDD archive (block×provider mobile coverage, 9 waves Jun 2010–Jun 2014; 4G proxy transtech=80 & maxaddown≥7, validated vs Verizon Dec-2010 LTE launch). First step if pursued: SBDD-vs-477 validation overlay. Gap confirmed open June 2026; topicality risk — move fast.
